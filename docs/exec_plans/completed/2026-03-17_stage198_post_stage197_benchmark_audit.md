# ExecPlan: Stage 198 Post-Stage-197 Benchmark Audit

## Summary
- Audit the fresh post-Stage-197 Home, Graph, Study, and focused-Study captures against the Recall benchmark direction.
...
## Problem Statement
- Stage 197 materially calmed Home again by carrying the visible continuation farther through the landing tail and by delaying the reveal footer.
...
## Goals
- Review fresh Stage 197 Home, Graph, Study, and focused-Study artifacts side by side with the benchmark direction.
...
## Inputs
- `scripts/playwright/stage197_home_tail_carry_extension_edge.mjs`
- `scripts/playwright/stage198_post_stage197_benchmark_audit_edge.mjs`
- `output/playwright/stage197-home-landing-desktop.png`
- `output/playwright/stage197-graph-browse-desktop.png`
- `output/playwright/stage197-study-browse-desktop.png`
- `output/playwright/stage197-focused-study-desktop.png`
- `output/playwright/stage197-home-tail-carry-extension-validation.json`

## Implementation Targets
- `docs/exec_plans/completed/2026-03-17_stage197_recall_home_tail_carry_extension_and_reveal_footer_delay.md`
- `docs/exec_plans/completed/2026-03-17_stage198_post_stage197_benchmark_audit.md`
- `docs/ROADMAP.md`
...
## Validation
- `node scripts/playwright/stage198_post_stage197_benchmark_audit_edge.mjs`
...
## Exit Criteria
- Fresh post-Stage-197 captures are reviewed and the clearest remaining blocker is identified.
...
## Outcome
- Stage 198 reran the fresh Home, Graph, Study, and focused-Study captures after the Stage 197 tail-carry-extension and reveal-footer-delay pass.
- The rerun matched the validated Stage 197 artifacts without drift, so the remaining mismatch is stable.
