# ExecPlan: Stage 178 Post-Stage-177 Benchmark Audit

## Summary
- Audit the fresh post-Stage-177 Home, Graph, Study, and focused-Study captures against the Recall benchmark direction.
- Verify whether carrying the visible Home continuation tail one step farther and lowering the reveal footer was enough to stop Home from leading the mismatch list.
...
## Problem Statement
- Stage 177 materially calmed Home again by carrying the visible continuation tail farther and by lowering the reveal footer in the landing.
...
## Goals
- Review fresh Stage 177 Home, Graph, Study, and focused-Study artifacts side by side with the benchmark direction.
- Confirm whether Home still leads the mismatch list after the tail-carry-extension and reveal-footer-lowering pass.
...
## Inputs
- `scripts/playwright/stage177_home_tail_carry_extension_edge.mjs`
- `scripts/playwright/stage178_post_stage177_benchmark_audit_edge.mjs`
- `output/playwright/stage177-home-landing-desktop.png`
- `output/playwright/stage177-graph-browse-desktop.png`
- `output/playwright/stage177-study-browse-desktop.png`
- `output/playwright/stage177-focused-study-desktop.png`
- `output/playwright/stage177-home-tail-carry-extension-validation.json`

## Implementation Targets
- `docs/exec_plans/completed/2026-03-17_stage177_recall_home_tail_carry_extension_and_reveal_footer_lowering.md`
- `docs/exec_plans/completed/2026-03-17_stage178_post_stage177_benchmark_audit.md`
- `docs/ROADMAP.md`
...
## Validation
- `node scripts/playwright/stage178_post_stage177_benchmark_audit_edge.mjs`
...
## Exit Criteria
- Fresh post-Stage-177 captures are reviewed and the clearest remaining blocker is identified.
...
## Outcome
- The Stage 178 audit reran the fresh Home, Graph, Study, and focused-Study captures and matched the validated Stage 177 artifacts without drift.
