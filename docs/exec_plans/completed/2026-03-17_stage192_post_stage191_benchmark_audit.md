# ExecPlan: Stage 192 Post-Stage-191 Benchmark Audit

## Summary
- Audit the fresh post-Stage-191 Home, Graph, Study, and focused-Study captures against the Recall benchmark direction.
- Verify whether lifting the visible Home continuation tail and pushing the reveal footer lower was enough to stop Home from leading the mismatch list.
...
## Problem Statement
- Stage 191 materially calmed Home again by lifting the visible continuation tail and by pushing the reveal footer lower in the landing.
...
## Goals
- Review fresh Stage 191 Home, Graph, Study, and focused-Study artifacts side by side with the benchmark direction.
...
## Inputs
- `scripts/playwright/stage191_home_tail_density_lift_edge.mjs`
- `scripts/playwright/stage192_post_stage191_benchmark_audit_edge.mjs`
- `output/playwright/stage191-home-landing-desktop.png`
- `output/playwright/stage191-graph-browse-desktop.png`
- `output/playwright/stage191-study-browse-desktop.png`
- `output/playwright/stage191-focused-study-desktop.png`
- `output/playwright/stage191-home-tail-density-lift-validation.json`

## Implementation Targets
- `docs/exec_plans/completed/2026-03-17_stage191_recall_home_tail_density_lift_and_reveal_footer_pushdown.md`
- `docs/exec_plans/completed/2026-03-17_stage192_post_stage191_benchmark_audit.md`
- `docs/ROADMAP.md`
...
## Validation
- `node scripts/playwright/stage192_post_stage191_benchmark_audit_edge.mjs`
...
## Exit Criteria
- Fresh post-Stage-191 captures are reviewed and the clearest remaining blocker is identified.
...
## Outcome
- The Stage 192 audit reran the fresh Home, Graph, Study, and focused-Study captures and matched the validated Stage 191 artifacts without drift.
