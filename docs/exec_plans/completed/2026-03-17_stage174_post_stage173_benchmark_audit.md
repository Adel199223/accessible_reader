# ExecPlan: Stage 174 Post-Stage-173 Benchmark Audit

## Summary
- Audit the fresh post-Stage-173 Home, Graph, Study, and focused-Study captures against the Recall benchmark direction.
- Verify whether carrying the visible Home continuation tail farther and pushing the reveal footer lower was enough to stop Home from leading the mismatch list.
...
## Problem Statement
- Stage 173 materially calmed Home again by carrying the visible continuation tail farther and by pushing the reveal footer lower in the landing.
...
## Goals
- Review fresh Stage 173 Home, Graph, Study, and focused-Study artifacts side by side with the benchmark direction.
- Confirm whether Home still leads the mismatch list after the continuation-tail-extension and reveal-footer-pushdown pass.
...
- `output/playwright/stage173-home-landing-desktop.png`
- `output/playwright/stage173-graph-browse-desktop.png`
- `output/playwright/stage173-study-browse-desktop.png`
- `output/playwright/stage173-focused-study-desktop.png`
- `output/playwright/stage173-home-continuation-tail-extension-validation.json`

## Implementation Targets
- `docs/exec_plans/completed/2026-03-17_stage173_recall_home_continuation_tail_extension_and_reveal_footer_pushdown.md`
- `docs/exec_plans/completed/2026-03-17_stage174_post_stage173_benchmark_audit.md`
- `docs/ROADMAP.md`
...
## Validation
- `node scripts/playwright/stage174_post_stage173_benchmark_audit_edge.mjs`
...
## Exit Criteria
- Fresh post-Stage-173 captures are reviewed and the clearest remaining blocker is identified.
...
## Outcome
- The Stage 174 audit reran the fresh Home, Graph, Study, and focused-Study captures and matched the validated Stage 173 artifacts without drift.
