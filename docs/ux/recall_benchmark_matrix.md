...
- Current refreshed audit set from March 28, 2026 after the Stage 709 audit:
  - `Home`: `output/playwright/stage709-home-wide-top.png`
  ...
  - `Graph`: `output/playwright/stage709-graph-wide-top.png`
  - embedded `Notebook`: `output/playwright/stage709-notebook-wide-top.png`
  - original-only `Reader`: `output/playwright/stage709-reader-original-wide-top.png`
  ...
  - `Study`: `output/playwright/stage709-study-wide-top.png`
